...
#import "moshouViewController.h"

@interface moshouViewController ()

@end

@implementation moshouViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    UIButton * button = [[UIButton alloc]initWithFrame:CGRectMake(20, 100, 100, 50)];
    [button setTitle:@"我是第6页" forState:UIControlStateNormal];
